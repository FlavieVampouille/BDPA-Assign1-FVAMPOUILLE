...
public class i_StopWords_10Reducers_NoCombiner extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		int res = ToolRunner.run(new Configuration(),new i_StopWords_10Reducers_NoCombiner(), args);
	...
	public int run(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "StopWords_10Reducers_NoCombiner");

		job.setJarByClass(i_StopWords_10Reducers_NoCombiner.class);
