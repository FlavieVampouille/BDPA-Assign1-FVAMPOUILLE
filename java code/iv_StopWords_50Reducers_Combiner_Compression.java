...
public class iv_StopWords_50Reducers_Combiner_Compression extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		int res = ToolRunner.run(new Configuration(),new iv_StopWords_50Reducers_Combiner_Compression(), args);
	...
	public int run(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "iv_StopWords_50Reducers_Combiner_Compression");

		job.setJarByClass(iv_StopWords_50Reducers_Combiner_Compression.class);
