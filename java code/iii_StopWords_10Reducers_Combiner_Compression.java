...
public class iii_StopWords_10Reducers_Combiner_Compression extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		int res = ToolRunner.run(new Configuration(),new iii_StopWords_10Reducers_Combiner_Compression(), args);
	...
	public int run(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "iii_StopWords_10Reducers_Combiner_Compression");

		job.setJarByClass(iii_StopWords_10Reducers_Combiner_Compression.class);
